...
function(vitasdk_add_pacman_client deps_dir install_dir zlib_target)
    ...
    if(CMAKE_CROSSCOMPILING)
        message(FATAL_ERROR
            "The package-client spike currently supports native Linux and macOS builds only")
    endif()
    ...
    ExternalProject_Add(pacman-client
        ...
        PATCH_COMMAND ${CMAKE_COMMAND}
            ...
            -P ${PROJECT_SOURCE_DIR}/cmake/VerifyGitRevision.cmake
